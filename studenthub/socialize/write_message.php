...
<ul class="nav nav-tabs">
  <li class="active"><a data-toggle="tab" href="#home">Write Message:</a></li>
</ul>
...
<form action="sendmessage.php?userid=<?php echo $userid; ?>" method="post">
  <input name="username" type="hidden" value="<?php echo $login_session ?>">
  <input name="receiver_username" type="hidden" value="<?php echo $username ?>">
