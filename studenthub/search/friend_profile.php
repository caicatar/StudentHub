...
<a href="../socialize/write_message.php?userid=<?php echo $userid; ?>"><p><button class="btn btn-primary" style="width: 200px; float: right; padding: 10px;">Message</button></p></a>
